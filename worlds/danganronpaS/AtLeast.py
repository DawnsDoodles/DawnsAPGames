...
class AtLeast(NestedRule["DanganronpaSWorld"], game="Archipelago"):
    ...
    def __init__(
        self,
        count: int | FieldResolver,
        *children: Rule[DanganronpaSWorld],
    ...
    @classmethod
    def from_resolved(cls, count: int, world: DanganronpaSWorld, children_to_process: list[Rule.Resolved]) -> Rule.Resolved:
